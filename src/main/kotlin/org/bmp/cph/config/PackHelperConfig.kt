...
data class MenuText(
    ...
    var authorsLabel: String? = null,
    var licenseLabel: String? = null,
    var projectPageLabel: String? = null,
...
private fun defaultTranslations(): Map<String, MenuText> = linkedMapOf(
    "en_us" to MenuText(
        ...
        authorsLabel = "Authors: {value}",
        licenseLabel = "License: {value}",
        projectPageLabel = "Project: {value}",
        backButton = "Back",
    ...
    "ru_ru" to MenuText(
        ...
        authorsLabel = "Авторы: {value}",
        licenseLabel = "Лицензия: {value}",
        projectPageLabel = "Страница проекта: {value}",
        backButton = "Назад",
...
object MenuTextResolver {
    ...
    fun resolve(menu: MenuConfig?, gameLanguageCode: String): ResolvedMenuText {
        ...
        return ResolvedMenuText(
            ...
            authorsLabel = pick("Authors: {value}") { it.authorsLabel },
            licenseLabel = pick("License: {value}") { it.licenseLabel },
            projectPageLabel = pick("Project: {value}") { it.projectPageLabel },
...
private fun englishValidationMessages(): Map<String, String> = mapOf(
    ...
    "invalid_icon_url" to "The icon must use a valid HTTPS URL.",
    "unsupported_icon_host" to "Icons are loaded only from official Modrinth or CurseForge CDNs.",
...
private fun russianValidationMessages(): Map<String, String> = mapOf(
    ...
    "invalid_icon_url" to "Для иконки требуется корректная HTTPS-ссылка.",
    "unsupported_icon_host" to "Иконки загружаются только с официальных CDN Modrinth или CurseForge.",
